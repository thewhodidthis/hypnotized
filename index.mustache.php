    ...
    <figure>
      <figure id="figure">
        <canvas id="canvas" height="300" width="500">
          <img src="screenshot.png" alt="Screenshot" height="300" width="500">
        </canvas>
      </figure>
      <figcaption>
        <h1>{{config.title}}</h1>
        <p>{{description}}. <a href="#more" title="Read more" hidden>More &rsaquo;</a></p>
      </figcaption>
    </figure>
    <aside id="more">
      <div>
        ...
        <blockquote>
          <picture>
            ...
            <source srcset="thumb-001.png" type="image/png">
            <img src="thumb-001.png" alt="Screenshot: Close up" width="250" height="150">
          </picture>
          <picture>
            <source srcset="thumb-002.webp" type="image/webp">
            <source srcset="thumb-002.png" type="image/png">
            <img src="thumb-002.png" alt="Screenshot: Core visual fading out into the distance" width="250" height="150">
          </picture>
          <p>Going through this animation from start to finish becomes somewhat less of a struggle as visits coverge in duration.</p>
        </blockquote>
        <ul>
          {{#repository}}
